...
if (isset($_POST['Movil']) ) {
		...
		$cx=conectar();			
		$query="Select*,td.nombre as nombre_tienda,of.nombre as nombre_oferta,of.descripcion as ofeta_descripcion, 
		DATE(of.fechaInicio) as ofertafe_inicio, DATE(of.fechaFinal) as ofertafe_final 
		From Detalle_Catalogo_Productos dcp, Imagen_Catalogo ic,Oferta of,catalogo cat,tienda td
		 ...
		 AND of.idOferta=dcp.Oferta_idOferta AND dcp.Catalogo_idCatalogo= cat.idCatalogo 
