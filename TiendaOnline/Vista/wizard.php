                ...
                <div class="x_content">
                  ...
                  <div id="wizard" class="form_wizard wizard_horizontal">
                    ...
                    <div id="step-1">   
                      ...
                      <form  action="#" method="post" class="file" enctype="multipart/form-data">
                        <div class="form-group">
                        <input id="fileupload" name="files" type="file" class="file" accept="image/jpeg" data-show-upload="false" >          
                        </div>                                
                      </form>
                       <br>
                    </div>
                    ...
                    <div id="step-2">                     
                        <div id="content">
                            <div id="background" class="background">              
                                <img id="obj_0" src="assets/lib_emoticones/background.jpg" width="640" height="480"></img>
                            </div>
                            <div id="tools">
                            </div>
                            <div id="objects">
