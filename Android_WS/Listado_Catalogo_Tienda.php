...
WHERE cat.Tienda_idTienda=td.idTienda AND td.idTienda={$idTienda}";
		//echo $query;
...
<html>
<head>
	<title>Listar Catalogos por Tienda</title>
</head>
<body>
	<h1> Listar Catalogos por Tienda</h1>
	<form action="<?php $_PHP_SELF ?>" method="post">
	Cod Agente de Credito:  <input type="text" name="idTienda" value="" /> <br/>		
