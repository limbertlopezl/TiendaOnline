          ...
          $(document).ready(function() {         
            $('#tabla_lista_Comerciantes').dataTable( {        
             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title" >
                  <h2>GESTIONAR TIENDAS <small>LISTADO</small></h2>

                  
                  <ul class="nav navbar-right panel_toolbox">
                       <a style="background:transparent;" href="V_Tienda_Agregar.php">
                ...
                <div class="x_content">      
                  ...
                  <table id="tabla_lista_Comerciantes" class="display table table-striped dataTable" cellspacing="0" width="100%"  style="margin-bottom:2px; padding-top: 10px;">
                    <thead>
                      <tr>                        
                        ...
                        <th style="background:black; color:white; text-align: center;">Nombre</th>                       
                         ...
                         <th style="background:black; color:white; text-align: center;">Web</th>                      
                         <th style="background:black; color:white; text-align: center;">Horario</th> 
